...
/**
  * @brief External Interrupt PORTB Interrupt routine. Active when a falling edge detected.
  * @param  None
  * @retval None
  */
INTERRUPT_HANDLER(EXTI_PORTB_IRQHandler, 4)
{
dmx512_handler_falling();
 
}

/**
  * @brief External Interrupt PORTC Interrupt routine. Active when the rising edge detected.
  * @param  None
  * @retval None
  */
